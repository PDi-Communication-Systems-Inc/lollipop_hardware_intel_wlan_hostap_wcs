...
static int wpa_cli_cmd_used_freqs(struct wpa_ctrl *ctrl, int argc, char *argv[])
{
	return wpa_cli_cmd(ctrl, "USED_FREQS", 0, argc, argv);
}
...
static const struct wpa_cli_cmd wpa_cli_commands[] = {
	...
	{ "used_freqs", wpa_cli_cmd_used_freqs, NULL, cli_cmd_flag_none,
		"= show list of frequencies used by any of the interfaces"
	},
