...
/*
 * Older libnl versions support only nlmsg_len, newer (>= 3) only support
 * nlmsg_datalen.
 */
#define nlmsg_datalen nlmsg_len
#endif /* CONFIG_LIBNL32 */
...
struct nl80211_global {
	...
	struct os_reltime cell_reception_loss;
	int during_cell_reception_loss;
#endif
};
...
struct wpa_driver_nl80211_data {
	...
	unsigned int support_vif_txpower:1;
	unsigned int self_managed_reg:1;
...
#else
static inline void nl80211_report_hang(struct wpa_driver_nl80211_data *drv)
{
}
